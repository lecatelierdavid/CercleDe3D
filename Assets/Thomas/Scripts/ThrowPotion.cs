...
public class ThrowPotion : MonoBehaviour {
	...
	void Start () {
        ...
        rightHand = gameObject.transform.Find("PlayerBody").Find("Main Camera").Find("PlayerHands").Find("PlayerRightHand").gameObject;
        PotionHold = rightHand.transform.Find("FirePotionHold").gameObject;
